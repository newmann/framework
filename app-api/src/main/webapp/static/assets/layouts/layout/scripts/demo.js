...
var Demo = function() {
    ...
    var handleTheme = function() {
        ...
        var setColor = function(color) {
            ...
            $('#style_color').attr("href", App.getAssetsPath() + Layout.getLayoutCssPath() + 'themes/' + color_ + ".min.css");
            if (color == 'light2') {
                $('.page-logo img').attr('src', App.getAssetsPath() + Layout.getLayoutImgPath() + 'logo-invert.png');
            } else {
                $('.page-logo img').attr('src', App.getAssetsPath() + Layout.getLayoutImgPath() + 'logo.png');
            }
        };
